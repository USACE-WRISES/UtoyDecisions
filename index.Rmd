...
eco <- read.csv("Utoy_Phase 2_EcoInputs_2024-08-04_EcoIn.csv", header=TRUE, dec=".", na.strings="NA", stringsAsFactors = FALSE)

#Import cost data
cost <- read.csv("Utoy_Phase 2_EcoInputs_2024-08-04_CostIn.csv", header=TRUE, dec=".", na.strings="NA", stringsAsFactors = FALSE)
```
...
plot(c(0, 1), c(0, 1), type = "n", 
     xlim = c(0,50), ylim = c(0,4), axes = FALSE, 
...
#Add legend
legend("topleft", legend = c("FWOP", "Alternative1"), lwd = 2, col = c("black", "blue"), bg = "white")
...
- Alternative3: Chain of wetlands.
...
- FWOP: Future WithOut Project.  
- Alternative1: Concrete channel removal with left bank wetland.  
- Alternative2: Concrete channel removal with bankfull bench.  
- Alternative3: Stabilization with natural bed and grade control.
...
- Alternative2: Channel and bank stabilization.  
- Alternative3: Bank stabilization only.
...
#SHOW AN EXAMPLE SITE (17F)
TableB01 <- cbind(cost_OMRRR_present$ReachID, cost_OMRRR_present$SiteAction,
...
colnames(TableB01) <- c("Site", "Alternative", "General Maintenance", "Bi-Annual Inspection", 
                       "Invasive Plant Management", "Structural Repair", "Total OMRRR", "OMRRR_ann / Project First")
rownames(TableB01) <- NULL
knitr::kable(TableB01, caption="Table B01. Operations, maintenance, repair, replacement, and rehabilitation (OMRRR) costs for all sites and alternatives in total present value.", align='c') 
