...
-   *Alternative3: Regrade segment around culvert*. Insert. 
...
knitr::kable(Table05, caption="Table 21. Summary of benefits and costs associated with site-scale recommendations.", align='c') 
```
...
## *Summary of the Tentatively Selected Plan (TSP)*

This is just placeholder text.

# **5. Economics, Socioeconomics, and Human Resources**

This is just placeholder text for an introduction.
...
U.S. Census Bureau, 2022 American Community Survey (ACS) 5-Year Estimates. Income in the Past 12 Months (in 2022 Inflation-Adjusted Dollars).
...
*Utoy Creek Watershed Demographics*: The Utoy Creek Watershed overlaps with 40 census tracts as delineated by the 2020 Census. Figure 3 below and its corresponding Tables 2-5 depict these Utoy Creek Watershed 2020 Census Tracts' population and population density profile, age and gender profile, ethnic profile, and income, employment and poverty profile.
...
Table0X <- cbind(census$Census.Tract.Number,
...
colnames(Table0X) <- c("Census Tract","Area (sq miles)", "Population (2020)", "Population Density per Sq Mile (2020)")
Table0X <- Table0X[-ncensus,]
rownames(Table0X) <- NULL
knitr::kable(Table0X, caption="Table 0X. Utoy Creek watershed census tracts population and density. Data from U.S. Census Bureau, 2020 Census Demographic Profile and U.S. Census Bureau 2023 Geographic Information Table.", align='c') 
```
...
What does this analysis tell us about the TSP?
